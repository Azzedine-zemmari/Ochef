...
select * from role;
insert into client(nom,prenom,adress,tel,email,password,RoleId) values("Zemmari","azzedine","Hey el massira LOTIS 500","0622328719","Azzedine@gmail.com","Azzedine2004",1);
select * from menu;
